...
function datas_from_mysql_without_multiple ($mysql_server_name, $mysql_user_name, $mysql_password, $mysql_database_name, $mysql_select, $mysql_from_and_others ){
    $mysql_data_we_need = array();
    $database = new mysqli("$mysql_server_name", "$mysql_user_name", "$mysql_password", "$mysql_database_name");
    $mysql_query_code = "SELECT DISTINCT $mysql_select FROM $mysql_from_and_others;";
